...
Original file is located at
    https://colab.research.google.com/drive/1hb5FdMOhnibfD94gCO7LQMSuv7IJ2mLx
"""
...
class Implication:
    ...
    def evaluate(self, facts):
        ...
        return Fact(expr) if len(new_lhs) and all([f.getResult() for f in new_lhs]) else  print("Does not entail")
